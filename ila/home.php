...
=======
>>>>>>> 8b85de62b0faf0b6c83c8b95264429522fe7a134
						<label for="radio-1">Animal</label>
>>>>>>> 5071f1e198077a0be36991f018cad622115ec620
						...
						<input type="radio" name="radio-1" value="Transportation" id="radio-33">
...
>>>>>>> 8b85de62b0faf0b6c83c8b95264429522fe7a134
		...
		<!--end div widget-->
				...
				<div class="content">
					<!--test get value Food & Transportation submit-->
					<?php
						if(isset($_POST['action']) and $_POST['action'] == 'Food')
						{	
...
<<<<<<< HEAD
						...
						?>
					<!--end test get value Food & Transportation submit-->
=======
							<div class="gallery">
								<figure>
									<a target="_blank" href="<?php echo $row['file'] ?>">
