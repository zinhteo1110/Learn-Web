...
$config["destination_folder"]			= 'home/haidn4/Documents/Learn-Web/login-registration-php-new/assets/images/'; //image directory ends with / (slash)
//$config["thumbnail_destination_folder"]		= 'home/Website/ajax-image-upload/uploads/'; //upload directory ends with / (slash)
$config["thumbnail_destination_folder"]		= 'home/haidn4/Documents/Learn-Web/login-registration-php-new/assets/images/'; //upload directory ends with / (slash)
//$config["upload_url"] 				= "http://website/ajax-image-upload/uploads/";
$config["upload_url"] 				= "http://localhost:8091/images/";
